...
public class TransactionAdapter extends ArrayAdapter<Transaction> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.senderName.setText(customersInfo.detailOfCustomer(transactions.get(position).getSenderAcc()).getName());
        viewHolder.receiverName.setText(customersInfo.detailOfCustomer(transactions.get(position).getReceiverAcc()).getName());
        return row;
    }
