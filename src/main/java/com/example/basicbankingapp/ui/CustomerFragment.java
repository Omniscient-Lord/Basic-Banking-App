...
public class CustomerFragment extends Fragment {
    ...
    private void updateCustomerList(){
        ...
        List<CustomerMockData> allCustomerMockData = customersInfo.allCustomers();

        CustomerAdapter listAdapter = new CustomerAdapter(context, R.layout.activity_customer_list, allCustomerMockData);
